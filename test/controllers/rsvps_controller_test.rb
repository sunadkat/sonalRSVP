...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { address: @rsvp.address, email: @rsvp.email, event: @rsvp.event, fname: @rsvp.fname, name: @rsvp.name, number: @rsvp.number }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { address: @rsvp.address, email: @rsvp.email, event: @rsvp.event, fname: @rsvp.fname, name: @rsvp.name, number: @rsvp.number }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
